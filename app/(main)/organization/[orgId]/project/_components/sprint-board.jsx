...
export default function SprintBoard({ sprints, projectId, orgId }) {
  ...
  const activeOrgId = orgId || organization?.id;
  ...
  useEffect(() => {
    if (currentSprint.id && activeOrgId) {
      fetchIssues(currentSprint.id, activeOrgId);
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  },[currentSprint.id, activeOrgId]);
  ...
  const onDragEnd = async (result) => {
    ...
    updateIssueOrderFn(sortedIssues, activeOrgId);
  };
                      ...
                      >
                        {(provided) => (
                          ...
                          >
                            <IssueCard
                              issue={issue}
                              onDelete={() => fetchIssues(currentSprint.id, activeOrgId)}
                              onUpdate={(updated) =>
                                setIssues((issues) =>
                                  issues.map((issue) => {
