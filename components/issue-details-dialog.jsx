...
export default function IssueDetailsDialog({
  ...
  const handleGoToProject = () => {
    if (membership?.organization?.id) {
      router.push(
        `/organization/${membership.organization.id}/project/${issue.projectId}?sprint=${issue.sprintId}`
      );
    }
  };

  // ✅ UPDATED: check to support org-based routes as well
  const isProjectPage = !pathname.startsWith("/project/") && !pathname.includes("/organization/");
